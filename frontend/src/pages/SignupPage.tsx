  ...
  return (
    <div className="min-h-screen bg-[#030712] flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-[#0f1729] border border-indigo-500/20 rounded-2xl p-8 shadow-2xl">
        <h1 className="font-display text-3xl font-bold text-slate-100 mb-1">Create account</h1>
        <p className="text-slate-400 text-sm mb-8">Join and secure your sessions.</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            <label htmlFor="name" className="block text-sm text-slate-400 mb-1.5">Full Name</label>
            <input
              id="name"
              type="text"
              value={name}
